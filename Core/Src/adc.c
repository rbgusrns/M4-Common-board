...
void HAL_ADC_MspInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  */
    ...
    PA3     ------> ADC1_IN4
    */
    GPIO_InitStruct.Pin = Q15_Pin|Q14_Pin|Q13_Pin|Q12_Pin;
  ...
  */
    ...
    PC4     ------> ADC2_IN5
    */
    GPIO_InitStruct.Pin = Q11_Pin|Q10_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);
    ...
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(Q9_GPIO_Port, &GPIO_InitStruct);
  ...
  */
    ...
    */
    ...
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(Q8_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = Q6_Pin|GPIO_PIN_9;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  */
    ...
    */
    ...
    GPIO_InitStruct.Pin = Q4_Pin|Q3_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA3     ------> ADC1_IN4
    */
    HAL_GPIO_DeInit(GPIOA, Q15_Pin|Q14_Pin|Q13_Pin|Q12_Pin);
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PC4     ------> ADC2_IN5
    */
    HAL_GPIO_DeInit(GPIOA, Q11_Pin|Q10_Pin);

    HAL_GPIO_DeInit(Q9_GPIO_Port, Q9_Pin);
  ...
  /* USER CODE END ADC3_MspDeInit 0 */
    ...
    PE9     ------> ADC3_IN2
    */
    HAL_GPIO_DeInit(Q8_GPIO_Port, Q8_Pin);

    HAL_GPIO_DeInit(GPIOE, Q6_Pin|GPIO_PIN_9);
  ...
  /* USER CODE END ADC4_MspDeInit 0 */
    ...
    PD9     ------> ADC4_IN13
    */
    HAL_GPIO_DeInit(Q5_GPIO_Port, Q5_Pin);

    HAL_GPIO_DeInit(GPIOD, Q4_Pin|Q3_Pin);
  ...
  /* USER CODE END ADC5_MspDeInit 0 */
    ...
    PD12     ------> ADC5_IN9
    */
    HAL_GPIO_DeInit(GPIOD, Q2_Pin|Q1_Pin|Q0_Pin);
