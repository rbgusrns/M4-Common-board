...
| Step | 발광핀 | 센서 Hi (S7→S0) | ADC Hi | 센서 Lo (S15→S8) | ADC Lo |
|---|---|---|---|---|---|
| 0 | L0 (PC14) | S7  (Q7)  | ADC3_IN2  (PE9)  | S15 (Q15) | ADC1_IN1  (PA0) |
| 1 | L1 (PC15) | S6  (Q6)  | ADC3_IN4  (PE7)  | S14 (Q14) | ADC1_IN2  (PA1) |
| 2 | L2 (PF9)  | S5  (Q5)  | ADC4_IN5  (PB15) | S13 (Q13) | ADC1_IN3  (PA2) |
| 3 | L3 (PF10) | S4  (Q4)  | ADC4_IN12 (PD8)  | S12 (Q12) | ADC1_IN4  (PA3) |
| 4 | L4 (PF1)  | S3  (Q3)  | ADC4_IN13 (PD9)  | S11 (Q11) | ADC2_IN3  (PA6) |
| 5 | L5 (PC0)  | S2  (Q2)  | ADC5_IN7  (PD10) | S10 (Q10) | ADC2_IN4  (PA7) |
| 6 | L6 (PC1)  | S1  (Q1)  | ADC5_IN8  (PD11) | S9  (Q9)  | ADC2_IN5  (PC4) |
| 7 | L7 (PC2)  | S0  (Q0)  | ADC5_IN9  (PD12) | S8  (Q8)  | ADC3_IN1  (PB1) |
...
```
 0µs ─── TIM Update IRQ ──→ LED ON (현재 step)
                │
12.5µs ── TIM OC IRQ ────→ ADC_Hi + ADC_Lo 동시 소프트웨어 트리거
                │
~13µs ─── ADC 변환 완료 ─→ DMA 전송 시작 (ADC_Hi, ADC_Lo 각각)
                │
~13.5µs ─ DMA 양쪽 완료 → LED OFF, 데이터 저장, step++
                │
25µs ──── 다음 TIM Update → 다음 LED ON
```
