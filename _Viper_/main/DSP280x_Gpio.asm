...
;*** 105	-----------------------    GpioCtrlRegs.GPAMUX2.all = 0x5020015uL;
;*** 116	-----------------------    GpioCtrlRegs.GPBMUX1.all = 0uL;
;*** 159	-----------------------    GpioCtrlRegs.GPADIR.all = 0xaecdffffuL;
